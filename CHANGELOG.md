...
### Shtuar
- **Faqja «Çka ka të re».** Historia e versioneve brenda aplikacionit — te *Më Shumë*, ose duke
  shtypur numrin e versionit te fundi i faqes (që më parë hapte vetëm një dritare me pesë versionet e
  fundit). Punon edhe pa internet, sepse lista është pjesë e vetë versionit që keni; çdo zë shfaq
  vetëm titullin e vet dhe hapet me një prekje, që të mos lexohet si mur teksti në telefon.
...
- **«Sa mund të shpenzoj sot» nuk ju fton më të shpenzoni kur muaji është në minus.** Shifra dilte
  ...
  Cilësimet, nën objektivin, shihet tani edhe si shumë: «= 541,95 € në muaj nga 1.806,50 €».
  <br />Kur objektivi është ai që vendos, karta e thotë hapur — dhe kur muaji e ka kaluar tashmë, ajo
  nuk tregon 0 € pa shpjegim, por sa ka shpenzuar mbi objektiv dhe se çdo shpenzim tani vjen nga
  kursimet. Pa objektiv kursimi gjithçka mbetet si më parë, dhe një limit fiks nga Cilësimet ka ende
  fjalën e fundit.
